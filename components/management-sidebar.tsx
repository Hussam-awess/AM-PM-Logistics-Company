...
import { LayoutDashboard, ClipboardList, Truck, Users, MessageSquare, LogOut, MapPin } from "lucide-react"
...
export default function ManagementSidebar() {
  ...
  const navItems = [
    ...
    { href: "/management/jobs", label: "Jobs", icon: ClipboardList },
  ]

  return (
    <div className="flex h-full w-64 flex-col border-r border-slate-200 bg-white">
      <div className="flex h-16 items-center border-b border-slate-200 px-6">
        <img src="/placeholder-logo.png" alt="AM-PM" className="h-8 w-8 rounded-md object-cover" />
        <div className="ml-3">
